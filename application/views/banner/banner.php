			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
						...
						<li class="nav-item">
							<a href="<?= base_url()?>index.php/banner/index/" class="nav-link active">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<div class="card card-primary card-outline">
					...
					<!-- /.card-header -->
					<div class="card-body">
						<a class="btn btn-primary" href="<?=base_url()?>index.php/banner/tambah">Tambah Data</a>
						<form action="<?=base_url()?>index.php/Banner/index" method="get">
							<table id="data_Banner" class="table table-bordered table-striped">
								<thead>
									<tr>
										<th>No</th>
										<th>Nama Gambar</th>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<img src="<?=base_url()?>assets/picture/<?=$data->image?>" alt="foto"
