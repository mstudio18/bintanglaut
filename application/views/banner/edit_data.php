					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="<?= base_url()?>index.php/Banner/index/">Home</a>
								</li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card card-primary">
							...
							<div class="card-body">
								<form action="<?=base_url()?>index.php/banner/updatedata" method="post"
									...
									<a class="btn btn-default float-left" href="http://localhost/bintanglaut/index.php/banner/index">back</a>
